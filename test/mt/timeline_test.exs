defmodule Mt.TimelineTest do
  use Mt.DataCase

  alias Mt.Timeline

  describe "posts" do
    alias Mt.Timeline.Post

    import Mt.TimelineFixtures

    @invalid_attrs %{body: nil, username: nil, like_count: nil, reposts_count: nil}
    ...
    test "create_post/1 with valid data creates a post" do
      valid_attrs = %{body: "some body", username: "some username", like_count: 42, reposts_count: 42}
    ...
    test "update_post/2 with valid data updates the post" do
      post = post_fixture()
      update_attrs = %{body: "some updated body", username: "some updated username", like_count: 43, reposts_count: 43}
